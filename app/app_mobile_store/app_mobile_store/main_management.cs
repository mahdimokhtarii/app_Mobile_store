...
{
    public partial class main_management : Form
    {
        public main_management()
        {
            InitializeComponent();
        }
        ...
        public main_management(string id, string name)
        {
            personnel_id = id;
            personnel_name = name;
            InitializeComponent();
        ...
        private void main_management_Load(object sender, EventArgs e)
        {
        ...
        private void insert_personnel_Click(object sender, EventArgs e)
        {
            record_personnel record_personnel_form = new record_personnel();
            record_personnel_form.back_main = this;
            this.Visible = false;
            record_personnel_form.Show();
        }

        private void management_personnel_Click(object sender, EventArgs e)
        {
            manage_personnel manage_personnel_Form = new manage_personnel();
            manage_personnel_Form.back_main = this;
            this.Visible = false;
            manage_personnel_Form.Show();
        }
    }
}
